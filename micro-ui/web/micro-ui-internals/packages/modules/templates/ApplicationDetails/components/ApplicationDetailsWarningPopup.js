...
return (
   ...
   <Card>
        <div style={{marginBottom:"30px"}}>
          <h1>{t("PT_YOU_HAVE")} Fdj {action?.AmountDueForPay} {t("PT_DUE_WARNING_MSG2")}</h1>
        </div>
       <Row rowContainerStyle={{display:"flex"}} labelStyle={{fontSize:"24px",fontWeight:"700",marginRight:"10%"}} textStyle={{fontSize:"24px",fontWeight:"700",marginBottom:"20px"}} label={`${t("PT_AMOUNT_DUE")}`} text={`Fdj ${t(action?.AmountDueForPay)}`} />
