      ...
      <div className="bill-summary">
          ...
          .map((amountDetails, index) => {
            return (
              <div key={index} className="bill-account-details">
                ...
                <div className="value">Fdj {Math.abs(amountDetails?.amount?.toFixed(2))}</div>
              </div>
            );
          })}

        {
          <div className="bill-account-details">
            ...
            <div className="value">Fdj {Math.abs(arrears?.toFixed?.(2) || Number(0).toFixed(2))}</div>
          </div>
        }
        ...
        <div className="amount-details">
          ...
          <div className="value">Fdj {Number(total).toFixed(2)}</div>
        </div>
      </div>
    </React.Fragment>
  );
