...
const amountFormatter = (value, denomination, t) => {
  ...
  switch (denomination) {
    case "Lac":
      return `Fdj ${currencyFormatter.format((value / 100000).toFixed(2) || 0)} ${t("ES_DSS_LAC")}`;
    case "Cr":
      return `Fdj ${currencyFormatter.format((value / 10000000).toFixed(2) || 0)} ${t("ES_DSS_CR")}`;
    case "Unit":
      return `Fdj ${currencyFormatter.format(value?.toFixed(2) || 0)}`;
    default:
      return "";
  }
};
